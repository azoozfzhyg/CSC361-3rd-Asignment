...
if dataset_choice == 1 :
    dataset_choice = "C:\\Users\\Admin\\Desktop\\DataSets\\heart_data.csv" # path for the dataset
elif dataset_choice == 2:
    dataset_choice = "C:\\Users\\Admin\\Desktop\\DataSets\\cardio_train.csv" # path for the dataset
elif dataset_choice == 3:
    dataset_choice = "C:\\Users\\Admin\\Desktop\\DataSets\\heart_failure_clinical_records_dataset.csv" # path for the dataset
##
...
while True:  # This creates an infinite loop
    ...
    model_names = {'1':'SVM', '2':'KNN', '3':'Decision Tree', '4':'Random Forest', '5':'Gradient Boosting',
                '6':'Neural Network', '7':'GaussianNB', '8':'AdaBoost', '9':'LDA', '10':'QDA',
    ...
    model_of_choice = {'SVM':svm.SVC(), 'KNN':NearestNeighbors(), 'Decision Tree':tree.DecisionTreeClassifier(),
                    ...
                    'Neural Network':MLPClassifier(), 'GaussianNB':GaussianNB(), 'AdaBoost':AdaBoostClassifier(),
...
#Got it ;}
    param_grids = {
        ...
        'Neural Network': {'hidden_layer_sizes': [(50,), (100,), (200,)], 'activation': ['relu', 'tanh', 'logistic'], 'max_iter': [1000, 2000]},
